...
export {
  ...
  type TpVerificationVariant,
} from './content/TpVerificationBadge';
...
export {
  ...
  TpNavDrawer,
  type TpNavDrawerItem,
  type TpNavDrawerProfile,
